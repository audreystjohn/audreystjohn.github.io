/**
* The CustomRender is an adapted version of Matter.CustomRender. ASJ created this 1/31/2023 per the advice of
* https://github.com/liabru/matter-js/issues/321 to add text to the rendered bodies.
*
* Original header:
* `Matter.CustomRender` module is a simple canvas based renderer for visualising instances of `Matter.Engine`.
...
(function() {
    ...
    CustomRender.world = function(render, time) {
        ...
        // ASJ moved this here so that the text of bodies shows clearer
        ...
        // ASJ - this is where it originally was; I moved to be done before bodies so text shows clearer
        // CustomRender.constraints(constraints, context);
    ...
    /**
     * CustomRenders statistics about the engine and world useful for debugging.
     * @private
     * @method stats
     * @param {render} render
    ...
    /**
     * CustomRenders engine and render performance information.
     * @private
     * @method performance
     * @param {render} render
     * @param {CustomRenderingContext} context
    ...
    /**
     * CustomRenders a label, indicator and a chart.
     * @private
     * @method status
     * @param {CustomRenderingContext} context
     * @param {number} x
     ...
     */
    CustomRender.status = function(context, x, y, width, height, count, label, indicator, plotY) {
        // background
    ...
    CustomRender.bodies = function(render, bodies, context) {
        ...
        for (i = 0; i < bodies.length; i++) {
            ...
            for (k = body.parts.length > 1 ? 1 : 0; k < body.parts.length; k++) {
                ...
                // ADDED ASJ per https://github.com/liabru/matter-js/issues/321 suggestion
                
                //Here's the custom part 
                if(part.render.text)
                {
                    //see above for default font size
