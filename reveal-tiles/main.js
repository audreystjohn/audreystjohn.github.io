...
function startGame() {
    ...
    // we want the message to be in order, so no shuffling!
    ...
    for(i=0; i<imgElementsArray.length; i++) {
        ...
        cardElements[i].appendChild(imgElementsArray[i]);
...
//         console.log( "cardElementsArray.length: " + cardElementsArray.length );
