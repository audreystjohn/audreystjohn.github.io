...
//     local : window.location.protocol == 'file:' ? 'index.html' : '',
    ...
    // ends the quiz
      ...
      '<div id="result-list"">'+
        ...
        '<div class="' + (EZQuiz.stats.score == 100 ? 'perfect-quiz' : EZQuiz.stats.score > 65 ? 'good-quiz' : '') + ' center">'+
          ( // depending on the score, a specific message will show
            EZQuiz.stats.score == 100 ? '<span style="font-size:24px;font-family:FontAwesome">PERFECTLY DONE!</span>' :
            EZQuiz.stats.score > 65 ? 'Good work! ' + wrong :
            'Keep studying! ' + wrong
          )+
          '<div class="center">'+
